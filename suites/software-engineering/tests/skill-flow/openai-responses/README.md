...
`task-intake -> solution-planning -> change-implementation -> change-review`

## User Request

```text
ช่วยวางแผนว่าจะย้าย OpenAI integration ใน suite นี้ไป Responses API ยังไงดี ตอนนี้ objective ชัดแล้วว่าอยากลดการพึ่ง Chat Completions แต่ยังไม่ควรแก้ code ทันที ถ้าได้แนวทางที่ชัดและปลอดภัยค่อย implement ต่อ แล้ว review งานปิดท้ายด้วย โดยของที่เกี่ยวข้องน่าจะอยู่แถว suites/software-engineering/tests/change-implementation/sample-app/src/openai
```

## Intake / Planning Artifacts

- implementation seam:
  - [client.ts](C:/Users/lattapon.kea/Desktop/Agents%20Skills/suites/software-engineering/tests/change-implementation/sample-app/src/openai/client.ts)
  - [support-assistant.ts](C:/Users/lattapon.kea/Desktop/Agents%20Skills/suites/software-engineering/tests/change-implementation/sample-app/src/openai/support-assistant.ts)
- focused proof target:
  - [support-assistant.test.ts](C:/Users/lattapon.kea/Desktop/Agents%20Skills/suites/software-engineering/tests/change-implementation/sample-app/src/openai/support-assistant.test.ts)
- planning prompts:
  - [solution-planning/cases.md](C:/Users/lattapon.kea/Desktop/Agents%20Skills/suites/software-engineering/tests/solution-planning/cases.md)
...
```powershell
node --test suites/software-engineering/tests/change-implementation/sample-app/src/openai/support-assistant.test.ts
```
