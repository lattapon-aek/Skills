# Core Implementation Mode Tests

Focused fixtures for forward-testing the `software-engineering-core` skill in `Implement` mode on real files in this repository.
